<h1 class="display-3">Teacher</h1>
          <form class="form-inline my-2 my-lg-0" method="post" action="dao/InsertTeacher.php">
          ...
          <input class="form-control mr-sm-2" type="text"  name="Title" placeholder="Title" aria-label="new">
