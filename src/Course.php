<h1 class="display-3">Course</h1>
          <form class="form-inline my-2 my-lg-0" method="post" action="dao/InsertCourse.php">
          ...
          <input class="form-control mr-sm-2" type="text" name="Description" placeholder="Description" aria-label="new">
